/*
	RRT_Spinner Library, by Douglas McKechie @ www.dougtesting.net
...
// ====================================================================================================================
// The constructor for the RRT_Spinner object, a JOSN-like array of options can be passed in.
// By default the wheel is drawn if canvas object exists on the page, but can pass false as second parameter if don't want this to happen.
// ====================================================================================================================
function RRT_Spinner(options, drawWheel)
{
	defaultOptions = {
...
// ====================================================================================================================
RRT_Spinner.prototype.updateSegmentSizes = function()
{
...
// ====================================================================================================================
RRT_Spinner.prototype.clearCanvas = function()
{
    if (this.ctx)
	{
...
// ====================================================================================================================
RRT_Spinner.prototype.draw = function(clearTheCanvas)
{
...
// ====================================================================================================================
RRT_Spinner.prototype.drawPointerGuide = function()
{
    ...
    if (this.ctx)
    {
        ...
        this.ctx.beginPath();
        this.ctx.moveTo(this.canvas.width / 2, this.canvas.height / 10);
...
// Grabs the arrow image from the document and draws it to mark the spinner.
RRT_Spinner.prototype.drawArrow = function() {
	  var image = document.getElementById("arrow");
	  this.ctx.drawImage(image, canvas.width / 2 - 17, 30, 30, 39);
}

// ====================================================================================================================
// This function takes an image such as PNG and draws it on the canvas making its center at the centerX and center for the wheel.
// ====================================================================================================================
RRT_Spinner.prototype.drawWheelImage = function()
{
...
// ====================================================================================================================
RRT_Spinner.prototype.drawSegments = function()
{
...
// ====================================================================================================================
RRT_Spinner.prototype.drawSegmentText = function()
{
...
// ====================================================================================================================
RRT_Spinner.prototype.degToRad = function(d)
{
...
// ====================================================================================================================
RRT_Spinner.prototype.setCenter = function(x, y)
{
	this.centerX = x;
	this.centerY = y;
}
...
// ====================================================================================================================
RRT_Spinner.prototype.addSegment = function(options, position)
{
...
// ====================================================================================================================
RRT_Spinner.prototype.setCanvasId = function(canvasId)
{
    if (canvasId)
    {
...
// ====================================================================================================================
RRT_Spinner.prototype.deleteSegment = function(position)
{
...
// ====================================================================================================================
RRT_Spinner.prototype.windowToCanvas = function(x, y)
{
...
// ====================================================================================================================
RRT_Spinner.prototype.getSegmentAt = function(x, y)
{
...
// ====================================================================================================================
RRT_Spinner.prototype.getSegmentNumberAt = function(x, y)
{
...
// ====================================================================================================================
RRT_Spinner.prototype.getIndicatedSegment = function()
{
...
// ====================================================================================================================
RRT_Spinner.prototype.getIndicatedSegmentNumber = function()
{
...
// ==================================================================================================================================================
RRT_Spinner.prototype.getRotationPosition = function()
{
...
// ==================================================================================================================================================
RRT_Spinner.prototype.startAnimation = function()
{
    if (this.animation)
    {
        ...
        RRT_SpinnerToDrawDuringAnimation = this;

        // Instruct tween to call the RRT_Spinner animation loop each tick of the animation
        // this is required in order to re-draw the wheel and actually show the animation.
        TweenMax.ticker.addEventListener("tick", RRT_SpinnerAnimationLoop);
        ...
        properties['onComplete'] = RRT_SpinnerStopAnimation;   // This is always set to function outside of this class.
...
// ==================================================================================================================================================
RRT_Spinner.prototype.stopAnimation = function(canCallback)
{
    ...
    RRT_SpinnerToDrawDuringAnimation.tween.kill();
    ...
    RRT_SpinnerToDrawDuringAnimation = this;
    RRT_SpinnerStopAnimation(canCallback);
}

// ==================================================================================================================================================
// Pause animation by telling tween to pause.
// ==================================================================================================================================================
RRT_Spinner.prototype.pauseAnimation = function()
{
    if (this.tween)
    {
        this.tween.pause();
...
// ==================================================================================================================================================
RRT_Spinner.prototype.resumeAnimation = function()
{
    if (this.tween)
    {
        this.tween.play();
...
// ====================================================================================================================
RRT_Spinner.prototype.computeAnimation = function()
{
    if (this.animation)
    {
...
// ====================================================================================================================
RRT_Spinner.prototype.getRandomForSegment = function(segmentNumber)
{
    var stopAngle = 0;
...
// ====================================================================================================================
function RRT_SpinnerPercentToDegrees(percentValue)
{
    var degrees = 0;
...
// of the class as for some reason it errors if try to call RRT_Spinner.draw() directly.
// ====================================================================================================================
var RRT_SpinnerToDrawDuringAnimation = null;  // This global is set by the RRT_Spinner class to the wheel object to be re-drawn.

function RRT_SpinnerAnimationLoop()
{
    if (RRT_SpinnerToDrawDuringAnimation)
    {
        // Check if the clearTheCanvas is specified for this animation, if not or it is not false then clear the canvas.
		if (RRT_SpinnerToDrawDuringAnimation.animation.clearTheCanvas != false)
        {
			RRT_SpinnerToDrawDuringAnimation.ctx.clearRect(0, 0, RRT_SpinnerToDrawDuringAnimation.canvas.width, RRT_SpinnerToDrawDuringAnimation.canvas.height);
		}

		// If there is a callback function which is supposed to be called before the wheel is drawn then do that.
        if (RRT_SpinnerToDrawDuringAnimation.animation.callbackBefore != null)
        {
            eval(RRT_SpinnerToDrawDuringAnimation.animation.callbackBefore);
        }

        // Call code to draw the wheel, pass in false as we never want it to clear the canvas as that would wipe anything drawn in the callbackBefore.
		RRT_SpinnerToDrawDuringAnimation.draw(false);

        // If there is a callback function which is supposed to be called after the wheel has been drawn then do that.
        if (RRT_SpinnerToDrawDuringAnimation.animation.callbackAfter != null)
        {
            eval(RRT_SpinnerToDrawDuringAnimation.animation.callbackAfter);
        }
    }
}
...
// ====================================================================================================================
function RRT_SpinnerStopAnimation(canCallback)
{
    // Remove the redraw from the ticker.
    TweenMax.ticker.removeEventListener("tick", RRT_SpinnerAnimationLoop);

    // When the animation is stopped if canCallback is not false then try to call the callback.
	// false can be passed in to stop the after happening if the animation has been stopped before it ended normally.
    if (canCallback != false)
    {
        if (RRT_SpinnerToDrawDuringAnimation.animation.callbackFinished != null)
        {
            eval(RRT_SpinnerToDrawDuringAnimation.animation.callbackFinished);
        }
    }
}
